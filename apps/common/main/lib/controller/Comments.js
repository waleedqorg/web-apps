...
define([
    ...
    Common.Controllers.Comments = Backbone.Controller.extend(_.extend({
        ...
        setMode: function(mode) {
            ...
            this.eoBindScopeSelect(); // top.legal: capture add-form choice + per-card scope changes
            return this;
        },
        ...
        eoDecodeScope: function (userData) {
            try { var o = JSON.parse(userData); if (o && (o.eoScope === 'internal' || o.eoScope === 'external' || o.eoScope === 'shared')) return o.eoScope; } catch (e) { }
            return 'shared';
        },
        eoEncodeScope: function (userData, scope) {
            var o = {};
            try { var p = JSON.parse(userData); if (p && typeof p === 'object') o = p; } catch (e) { }
            o.eoScope = scope;
...
//                    }
        ...
        readSDKComment: function (id, data, requestObj) {
            ...
            var comment = new Common.Models.Comment({
                ...
                eoScope             : this.eoDecodeScope(data.asc_getUserData()),   // top.legal: scope from userData (round-trips); absent => shared
                userid              : userid,
